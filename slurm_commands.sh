...
python benchmarks.py --model_idx=2 --batch_idx=4 --mem_ratio=0.7 > logs/benchmark_2_3.out
python benchmarks.py --model_idx=2 --batch_idx=4 --mem_ratio=0.5 > logs/benchmark_2_3.out